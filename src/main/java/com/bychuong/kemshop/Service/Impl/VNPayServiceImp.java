...
import com.bychuong.kemshop.Config.VNPayConfig;
import com.bychuong.kemshop.DTO.Request.VNPayRequest;
import com.bychuong.kemshop.Service.VNPayService;
...
public class VNPayServiceImp implements VNPayService {
    ...
    public String createPayment(VNPayRequest paymentRequest) throws UnsupportedEncodingException {
        ...
        BigDecimal amount;
        try {
            amount = new BigDecimal(String.valueOf(paymentRequest.getAmount())).multiply(BigDecimal.valueOf(100));
