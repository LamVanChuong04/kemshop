...
import com.bychuong.kemshop.Entity.TokenType;
import com.bychuong.kemshop.Repository.CustomerRepository;
import com.bychuong.kemshop.Repository.TokenRepository;
import com.bychuong.kemshop.Service.JwtService;
...
//    }
    ...
    public AuthenticationResponse login(AuthenticationRequest request) {
        // 1. Xác thực credentials (email + password)
        ...
        // 4. Lưu token vào DB (nếu bạn có bảng token)
    ...
    private void saveUserToken(CustomerEntity user, String jwtToken) {
    ...
    private void revokeAllUserTokens(CustomerEntity user) {
